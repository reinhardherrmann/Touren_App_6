...
class TourenDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_touren_detail, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment TourenDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TourenDetailFragment().apply {
